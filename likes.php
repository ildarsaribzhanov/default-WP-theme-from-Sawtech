<div class="post_likes">
	...
	<div class="like_itm">
		<a href="https://twitter.com/share" class="twitter-share-button" data-url="<?php echo $like_url; ?>"
			data-text="<?php the_title(); ?> <?php the_permalink(); ?> ">Tweet</a>
	...
	<div class="like_itm">
		<div class="fb-like" data-href="<?php get_permalink(); ?>" data-layout="button_count" data-action="like"
