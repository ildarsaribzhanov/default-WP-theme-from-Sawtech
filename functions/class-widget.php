...
class My_New_Best_Wordpress_widget extends WP_Widget {
	...
	public function form( $instance )
	{
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'count_posts' ); ?>"><?php _e( 'Количество отображаемых пользователей:' ); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'count_posts' ); ?>" name="<?php echo $this->get_field_name( 'count_posts' ); ?>" type="text" value="<?php echo  $count_posts; ?>" />
		</p>
		<?php
	}
}
